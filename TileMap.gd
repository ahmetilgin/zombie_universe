...
onready var obstacles = get_used_cells_by_id(0) + get_used_cells_by_id(1) +\
						get_used_cells_by_id(2) + get_used_cells_by_id(6) +\
						get_used_cells_by_id(10) +get_used_cells_by_id(14) +\
						get_used_cells_by_id(15) +get_used_cells_by_id(16) 
