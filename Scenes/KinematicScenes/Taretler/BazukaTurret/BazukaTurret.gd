...
const turret_bullet = preload("res://Scenes/KinematicScenes/Taretler/TurretBullet/BazukaTurretBullet/BazukaTurretBullet.tscn")
...
func _on_CloseRotationTimer_timeout():
	hide_rotations()
	pass # Replace with function body.
